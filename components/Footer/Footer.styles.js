...
const styles = StyleSheet.create({
  ...
  footerUl: { flexDirection: "row", height: "100%", display: "flex", justifyContent: "center", padding: "0", listStyleType: "none", color: "#fff", marginBlockStart: "0", marginInlineStart: "0px", marginInlineEnd: "0px", fontFamily: '"Helvetica", "Arial", sans-serif' },
